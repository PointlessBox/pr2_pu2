...
//		Schurke<?> S4 = new Schurke<>("S4", 10000, "GroﬂeNase", Superkraft.SUPERFEUER,  Superkraft.SUPERSPEED);
//		
...
//		System.out.println(Finanzamt.getFinanzamt().berechne());
		...
		Schurke<Mutant<?>> Sc1 = new Schurke<>("Sc1", 10000, "GroﬂeNase", Superkraft.SUPERSTARK, Superkraft.SUPERFEUER,
				Superkraft.SUPERSPEED);
		Schurke<Mutant<?>> Sc2 = new Schurke<>("Sc2", 20000, "GroﬂeNase", Superkraft.UNSICHTBARKEIT,
				Superkraft.SUPERFEUER);
		Schurke<Mutant<?>> Sc3 = new Schurke<>("Sc3", 120000, "GroﬂeNase", Superkraft.UNSTERBLICHKEIT,
				Superkraft.SUPERFEUER, Superkraft.UNSICHTBARKEIT);
		Schurke<Mutant<?>> Sc4 = new Schurke<>("Sc4", 130000, "GroﬂeNase", Superkraft.SUPERFEUER, Superkraft.SUPERSPEED);
